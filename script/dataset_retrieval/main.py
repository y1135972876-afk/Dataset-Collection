...
def main():
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="/home/kzlab/muse/Savvy/Data_collection/script/retrival/dataset_retrieval/dataset_retrieval/models/Alibaba-gte-large-en-v1.5",
        help="指定用于检索的模型名称"
    )
    parser.add_argument(
        "--with-instruction",
    ...
    print("初始化检索框架...")
    framework = RetrievalFramework(data_dir="/home/kzlab/muse/Savvy/Data_collection/script/retrival/dataset_retrieval/dataset_retrieval/datasets/final_dataset.json/")
